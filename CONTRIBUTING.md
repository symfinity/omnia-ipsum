...
> **Read-only mirror.** This repository (`symfinity/omnia-ipsum`) is published from the Symfinity product monorepo (`packages/omnia-ipsum/`). **Do not expect pull requests to be merged here.**

## Report bugs or request features

Open an [issue](https://github.com/symfinity/omnia-ipsum/issues) on this repository.
...
Open a pull request on the **product monorepo** (`packages/omnia-ipsum/`) on a `feature/{spec-id}-{slug}` branch. Do not rely on merging on this mirror.
